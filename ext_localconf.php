...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPageTSConfig('
	...
	mod.web_txtemplavoilaplusM1.javascript.file1 = ' . \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('templavoila_framework') . 'Resources/Public/JavaScript/backend.js

	#Include css file for backend styling
	mod.web_txtemplavoilaplusM1.stylesheet = ' . \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('templavoila_framework') . 'Resources/Public/StyleSheets/backend.css
');
...
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['templavoilaplus']['staticDataStructures'] = array_merge(
	(array) $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['templavoilaplus']['staticDataStructures'],
