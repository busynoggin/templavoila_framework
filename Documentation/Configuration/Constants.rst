...
.. list-table::
    ...
    *
        ...
        -
            Description
                This constant must be at the beginning of your skin constants. It tells the Framework which version of rendering to use. Possible values are 1 or 2.
            Full TypoScript path
                plugin.tx_templavoilaframework.renderMode
            Default
                Null
...
Constants you will sometimes set
================================
...
.. list-table::
    ...
    *
        -
            columnModuleRenderMode
        -
            Description
                This can change the layout of the column and module groups. You would not touch this unless you are doing adaptive design with the Busy Noggin Adaptive profiles extension (bn_adaptiveprofiles). It is used to generated different layouts for different size screens. Possible values are normal, intermediate and full.
            Full TypoScript path
                plugin.tx_templavoilaframework.baseDefaults.settings.[contentBlockKey].columnModuleRenderMode
                plugin.tx_templavoilaframework.[templateKey].settings.[contentBlockKey].columnModuleRenderMode

            Default
                normal


Constants mere mortals should not touch
================================
