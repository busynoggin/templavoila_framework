...
Sites like `CSS Zen Garden <http://www.csszengarden.com/>`_ do a good job of showing how much a site can change simply through modifying the CSS.
...
However, we do not recommend using the version 1 skins for any new site development. Rather, develop a custom skin for your site using version 2 code. There is a Busy Noggin wireframe skin based on version 2 code. Instructions for downloading that skin are later in this document. This wireframe skin can be used as a starting point for new skins.

Skins can be extensions or simply reside in your directory for custom skins.

// @todo-ron Update Wireframe skin in the TER to the v2 skin. Upgrade AT-Bone starter to v2 and set both to requrie v2
